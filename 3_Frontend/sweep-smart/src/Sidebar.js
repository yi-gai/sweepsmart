  ...
  return (
    <SvgIcon {...props}>
      <svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M13.2422 1.17188H12.5391V0H11.3672V1.17188H3.63281V0H2.46094V1.17188H1.75781C0.788555 1.17188 0 1.96043 0 2.92969V13.2422C0 14.2114 0.788555 15 1.75781 15H13.2422C14.2114 15 15 14.2114 15 13.2422V2.92969C15 1.96043 14.2114 1.17188 13.2422 1.17188ZM13.8281 13.2422C13.8281 13.5653 13.5653 13.8281 13.2422 13.8281H1.75781C1.43473 13.8281 1.17188 13.5653 1.17188 13.2422V5.50781H13.8281V13.2422ZM13.8281 4.33594H1.17188V2.92969C1.17188 2.6066 1.43473 2.34375 1.75781 2.34375H2.46094V3.51562H3.63281V2.34375H11.3672V3.51562H12.5391V2.34375H13.2422C13.5653 2.34375 13.8281 2.6066 13.8281 2.92969V4.33594Z" fill="#70C295"/>
        <path d="M3.39844 6.73828H2.22656V7.91016H3.39844V6.73828Z" fill="#70C295"/>
        <path d="M5.74219 6.73828H4.57031V7.91016H5.74219V6.73828Z" fill="#70C295"/>
        <path d="M8.08594 6.73828H6.91406V7.91016H8.08594V6.73828Z" fill="#70C295"/>
        <path d="M10.4297 6.73828H9.25781V7.91016H10.4297V6.73828Z" fill="#70C295"/>
        <path d="M12.7734 6.73828H11.6016V7.91016H12.7734V6.73828Z" fill="#70C295"/>
        <path d="M3.39844 9.08203H2.22656V10.2539H3.39844V9.08203Z" fill="#70C295"/>
        <path d="M5.74219 9.08203H4.57031V10.2539H5.74219V9.08203Z" fill="#70C295"/>
        <path d="M8.08594 9.08203H6.91406V10.2539H8.08594V9.08203Z" fill="#70C295"/>
        <path d="M10.4297 9.08203H9.25781V10.2539H10.4297V9.08203Z" fill="#70C295"/>
        <path d="M3.39844 11.4258H2.22656V12.5977H3.39844V11.4258Z" fill="#70C295"/>
        <path d="M5.74219 11.4258H4.57031V12.5977H5.74219V11.4258Z" fill="#70C295"/>
        <path d="M8.08594 11.4258H6.91406V12.5977H8.08594V11.4258Z" fill="#70C295"/>
        <path d="M10.4297 11.4258H9.25781V12.5977H10.4297V11.4258Z" fill="#70C295"/>
        <path d="M12.7734 9.08203H11.6016V10.2539H12.7734V9.08203Z" fill="#70C295"/>
      </svg>
    </SvgIcon>
  );
}
