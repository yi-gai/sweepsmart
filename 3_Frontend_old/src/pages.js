...
class HomePage extends React.Component {
  ...
  render() {
    return (
      <div>
        <h1>Web Arch Assignment I Blog Homepage</h1>

    <div className={skeleton.container}> 
      <h4> <a onClick={() => this.props.clickSwitch(<BlogPost1Page clickSwitch={this.props.clickSwitch}/>)}> 8 Experiments in Motivation </a></h4>
      ...
      <a onClick={() => this.props.clickSwitch(<BlogPost1Page clickSwitch={this.props.clickSwitch}/>)}> Read More </a>
    </div>

    <div className={skeleton.container}> 
      <h4> <a onClick={() => this.props.clickSwitch(<BlogPost2Page clickSwitch={this.props.clickSwitch}/>)}> A Mindful Shift of Focus </a> </h4>
      <p> 
        <div> </div>
      ...
      <a onClick={() => this.props.clickSwitch(<BlogPost2Page clickSwitch={this.props.clickSwitch}/>)}> Read More </a>
    </div>

    <div className={skeleton.container}> 
      <h4> <a onClick={() => this.props.clickSwitch(<BlogPost3Page clickSwitch={this.props.clickSwitch}/>)}> How to Develop an Awesome Sense of Direction </a> </h4>
      <p> 
        <div> </div>
      ...
      <a onClick={() => this.props.clickSwitch(<BlogPost3Page clickSwitch={this.props.clickSwitch}/>)}> Read More </a>
    </div>

    <div className={skeleton.container}> 
      <h4> <a onClick={() => this.props.clickSwitch(<BlogPost4Page clickSwitch={this.props.clickSwitch}/>)}> Training to Be a Good Writer </a> </h4>
      <p> 
        <div id = "author"> </div>
      ...
      <a onClick={() => this.props.clickSwitch(<BlogPost4Page clickSwitch={this.props.clickSwitch}/>)}> Read More </a>
    </div>

    <div className={skeleton.container}> 
      <h4> <a onClick={() => this.props.clickSwitch(<BlogPost5Page clickSwitch={this.props.clickSwitch}/>)}> What Productivity Systems Won't Solve </a> </h4>
      <p> 
        <div id = "author"> </div>
      ...
      <a onClick={() => this.props.clickSwitch(<BlogPost5Page clickSwitch={this.props.clickSwitch}/>)}> Read More </a>
    </div>
  ...
  render() {
    return (
      <div className={skeleton.container}>
        ...
        <br></br>
        <br></br>
        Welcome to my first blog! I am very glad to have taken the Web Architecture course during my first semester as a graduate student at the I School. Look what we have learnt to build just out of 5 classes! Exciting right?
        <br></br>
        <br></br>
        I am so much looking forward to learn how to bring it to the internet:) 
        <br></br>
        <br></br>
        Have something to tell? Go to the "Contact us" link below.
        <br></br>
        <br></br>
      </p>
      <a onClick={() => this.props.clickSwitch(<ContactUsPage clickSwitch={this.props.clickSwitch}/>)}> Contact Us </a>
      </div>
    );
  }
}
...
class ContactUsPage extends React.Component {
  ...
  checkEmpty(e) {
    if (this._inputName.value === "") {
        this.setState({submitResult : "Name is a required field, please fill in the Name filed before submission."});
    } else if (this._inputSubject.value === "") {
        this.setState({submitResult : "Subject is a required field, please fill in the Subject filed before submission."});
    } else if (this._inputMessage.value === "") {
      this.setState({submitResult : "Message is a required field, please fill in the Message filed before submission."});
    } else if (this._inputName.value !== "" && this._inputSubject.value !== "" && this._inputMessage.value !== "") {
      // d.reset();
      this.setState({submitResult : "Your message has been sent."});
      this.props.addContact({name: this._inputName.value, subject: this._inputSubject.value, message: this._inputMessage.value});
      this.props.clickSwitch(<HomePage clickSwitch={this.props.clickSwitch}/>);
  }
  e.preventDefault();
  }
  ...
  render() {
    return (
      <div id="submitResult">
        <div> {this.state.submitResult} </div>
      
    
        <form id="contactForm" onSubmit={this.checkEmpty}>
    
        <table>
        <tbody>
        <tr> 
          <td> Name </td>
          <td> <input ref={(a) => this._inputName = a} className = {mystyle.name} type="text"></input> </td>
        </tr>
        <tr> 
          <td> Subject </td>
          <td> <input ref={(a) => this._inputSubject = a} className = {mystyle.subject} type="text"></input></td>
        </tr>
        <tr> 
          <td> Message </td>
          <td> <input ref={(a) => this._inputMessage = a} className = {mystyle.message} type="text"></input> </td>
        </tr>
        </tbody>
        </table> 
...
class ContactUsSubmissions extends React.Component {
  // implement this class
  constructor(props) {
    super(props);
  ...
  createTable(item) {
    ...
    //       <td> Message </td>
    //       <td> {item.message} </td>
    //     </tr>) one variable cannot be wrapped in many layers of tabs. Use just one!!!
    return <tr> Name: {item.name}; Subject: {item.subject}; Message: {item.message} </tr>
  }

  render() {
    var allSubmissionItem = this.props.allSubmissions
    console.log(allSubmissionItem);
    var submissionItems = allSubmissionItem.map(this.createTable)
    return (
      <div id="submitResult">
        All contact submission
        <table> <tbody>
        {submissionItems}
        </tbody> </table> 
      </div>
...
class BlogPost1Page extends React.Component {
  // implement this class
  constructor(props) {
    super(props);
    this.state = {comment:[]};
  ...
  addComment(e) {
    var item = {name: this._inputName.value, comment: this._inputComment.value}
    this.setState((prevState) => {
      var newComment = prevState.comment;
  ...
  createTable(item) {
    ...
    return <tr> Name: {item.name}; Comment: {item.comment} </tr>
  }

  render() {
    var commentList = this.state.comment;
    var allComments = commentList.map(this.createTable);
    return (
      <div>
        <h3>8 Experiments in Motivation</h3>
    <div id = "author"> <p>By Leo Babauta</p> </div>
    <div className={skeleton.container}> 
...
<p>At the end of these, you'll have tried a bunch of great methods, and figured out what helps you most. You might combine methods, or use different ones at different times. And maybe after all of this, you'll have a trust in yourself that's so strong, you don't need any methods!</p>
      <a onClick={() => this.props.clickSwitch(<BlogPost2Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.next}> Next blogpost: A Mindful Shift of Focus </a>
      <br></br>
      </div>
        <form id="contactForm" onSubmit={this.addComment}>
        ...
        <tr>
          <td> Comment </td>
          <td> <input ref={(a) => this._inputComment = a} className = {mystyle.message} type="text"></input> </td>
        </tr>
        </tbody>
        </table> 
        <button type="submit"> Submit </button>
...
class BlogPost2Page extends React.Component {
  // implement this class
  constructor(props) {
    super(props);
    this.state = {comment:[]};
...
<br></br>
      <p><a onClick={() => this.props.clickSwitch(<BlogPost1Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.last}> Previous blogpost: 8 Experiments in Motivation </a><br></br><a onClick={() => this.props.clickSwitch(<BlogPost3Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.next}> Next blogpost: How to Develop an Awesome Sense of Direction </a></p>
...
class BlogPost3Page extends React.Component {
  // implement this class
  constructor(props) {
    super(props);
    this.state = {comment:[]};
...
<p>In my experience, this is a key skill for traveling, and it makes every trip so much more fun when you can really figure out a city and start to understand it like a local does. Happy wandering, my friends.</p>
    <br></br>
    <p><a onClick={() => this.props.clickSwitch(<BlogPost2Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.last}> Previous blogpost: A Mindful Shift of Focus </a> <br></br> <a onClick={() => this.props.clickSwitch(<BlogPost4Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.next}> Next blogpost: Training to Be a Good Writer </a></p>
    </div>
      <form id="contactForm" onSubmit={this.addComment}>
...
class BlogPost4Page extends React.Component {
  // implement this class
  constructor(props) {
    super(props);
    this.state = {comment:[]};
...
<li><strong>You get good by doing it a lot, and caring.</strong> You'll never be perfect at it -- goodness knows I'm far from perfect -- but the only way to get better is to practice. And to care about what you're doing. Do that every day, and every step of the struggle will be an amazing one.</li>
      ...
      <p><a onClick={() => this.props.clickSwitch(<BlogPost3Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.last}> Previous blogpost: How to Develop an Awesome Sense of Direction </a><br></br><a onClick={() => this.props.clickSwitch(<BlogPost5Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.next}> Next blogpost: What Productivity Systems Won't Solve </a></p>
...
class BlogPost5Page extends React.Component {
  // implement this class
  constructor(props) {
    super(props);
    this.state = {comment:[]};
...
<br></br>
      ...
      <p><a onClick={() => this.props.clickSwitch(<BlogPost4Page clickSwitch={this.props.clickSwitch}/>)} className={mystyle.last}> Previous blogpost: Training to Be a Good Writer </a></p>
    </div>
      <form id="contactForm" onSubmit={this.addComment}>
...
export {HomePage, AboutUsPage, ContactUsPage, ContactUsSubmissions, BlogPost1Page, BlogPost2Page, BlogPost3Page, BlogPost4Page, BlogPost5Page};
